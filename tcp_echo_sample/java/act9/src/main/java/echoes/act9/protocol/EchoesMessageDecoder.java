...
/**
 * Echoes Act9 ByteBuffer to message POJO decoder.
 *
...
public class EchoesMessageDecoder extends CumulativeProtocolDecoder {
            ...
            ProtocolDecoderOutput out) throws Exception
    {
        ...
        EchoesMessage m = new EchoesMessage(mark, length, in);

        // CumulativeProtocolBuffer assumes ByteBuffer.remaining() must be 0
        // when doDecode() return true.
